...
package provide RivetEntities 1.0.1
...
#   namespace ensemble create -subcommands {encode decode}
    ...
    proc args_processing {string mode arglist} {
        ...
        if {[dict exists $arglist -encoding] && [dict get $arglist -encoding] ne "utf-8"} {
...
#
    ...
    proc encode {string args} {
        variable utf8_entities_map
        return [string map $utf8_entities_map [args_processing $string convertfrom $args]]
    }
...
#
    ...
    proc decode {string args} {
        ...
        return [args_processing [string map $entitities_utf8_map $string] convertto $args]
    }
}
